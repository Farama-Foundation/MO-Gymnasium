...
class MOMountainCar(MountainCarEnv, EzPickle):
    ...
    ## Reward space:
    The reward space is a 2D vector containing the time penalty, and penalties for reversing and going forward have been compiled into one called the movement penalty.
