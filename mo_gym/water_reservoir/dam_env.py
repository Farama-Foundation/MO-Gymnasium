...
class DamEnv(gym.Env):
    ...
    s_init = np.array([9.6855361e+01,
              ...
              4.4351321e+01,
              1.3185943e+01,
              7.3508622e+01,], dtype=np.float32)
    
    metadata = {"render_modes": []}

    def __init__(self, render_mode: Optional[str] = None, time_limit: int = 100, nO = 2, penalize: bool = False):
