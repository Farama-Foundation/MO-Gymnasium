...
| `mo-reacher-v4` <br><img src="https://raw.githubusercontent.com/Farama-Foundation/MO-Gymnasium/main/screenshots/reacher-mujoco.png" width="200px">                          | Continuous / Discrete               | `[target_1, target_2, target_3, target_4]`                    | Similar to `mo-reacher-v0`, but based on Mujoco's `Reacher-v04` [environment](https://gymnasium.farama.org/environments/mujoco/reacher/). |
